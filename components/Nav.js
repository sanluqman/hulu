...

{
  /* <div className="flex px-10 sm:px-20 text-2xl whitespace-nowrap
            space-x-10 sm:space-x-20 overflow-x-scroll overflow-y-hidden scrollbar-hide"></div> */
}
...
const Nav = () => {
  ...
  return (
    <nav>
      <div className="flex px-20 sm:px-10 text-2xl whitespace-nowrap space-x-7 overflow-x-scroll scrollbar-hide">
